      ...
      <div className={styles.page}>
        <div className={`glass-card ${styles.card}`}>
          ...
          <div className={styles.links}>
            <Link href="/forgot-password" className={styles.link}>{t("login", "forgot")}</Link>
            <span className={styles.linkDivider}>·</span>
            <Link href="/register" className={styles.link}>{t("login", "createAccount")}</Link>
          </div>

          <p className={styles.legal}>
            {t("login", "legal")}<a href="#">{t("login", "termsLink")}</a>{t("login", "and")}<a href="#">{t("login", "privacyLink")}</a>.
          </p>
        </div>
      </div>
    </>
