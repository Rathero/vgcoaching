...
export const reviews: Review[] = [
  { id: "r1", bookingId: "b1", coachId: "c1", studentId: "s1", studentName: "Carlos M.", studentAvatar: "👨‍💻", rating: 5, comment: "De Oro IV a Platino I en 3 semanas. DarkMaster me hizo ver errores de positioning que ni sabía que cometía.", rankBefore: "Oro IV", rankAfter: "Platino I", sessionsCount: 3, createdAt: "2025-02-15" },
  { id: "r2", bookingId: "b2", coachId: "c1", studentId: "s2", studentName: "María G.", studentAvatar: "👩‍🎓", rating: 5, comment: "Increíble coach. Explica todo con mucha paciencia y se nota que domina el juego a otro nivel.", rankBefore: "Plata I", rankAfter: "Oro II", sessionsCount: 5, createdAt: "2025-03-01" },
  { id: "r3", bookingId: "b3", coachId: "c1", studentId: "s3", studentName: "Diego L.", studentAvatar: "🧑‍💻", rating: 4, comment: "Muy buen coach. Me ayudó mucho con el wave management. Solo le falta un poco más de flexibilidad de horarios.", rankBefore: "Platino III", rankAfter: "Esmeralda IV", sessionsCount: 4, createdAt: "2025-01-20" },
  { id: "r4", bookingId: "b4", coachId: "c2", studentId: "s4", studentName: "Ana R.", studentAvatar: "👩‍🎮", rating: 5, comment: "ValkyrieSup me cambió completamente la forma de jugar support. Ahora entiendo cuándo roamear y cuándo quedarme.", rankBefore: "Plata III", rankAfter: "Oro I", sessionsCount: 6, createdAt: "2025-02-28" },
  { id: "r5", bookingId: "b5", coachId: "c2", studentId: "s5", studentName: "Pablo F.", studentAvatar: "👨‍🎮", rating: 5, comment: "Excelente visión del juego. Me enseñó ward spots que no conocía y cómo controlar la visión del mapa.", rankBefore: "Oro II", rankAfter: "Platino III", sessionsCount: 4, createdAt: "2025-03-15" },
  { id: "r6", bookingId: "b6", coachId: "c3", studentId: "s6", studentName: "Lucía R.", studentAvatar: "👩‍🎮", rating: 5, comment: "Llevaba 2 años estancada en Plata. En 5 sesiones de jungle pathing subí a Oro III. Lo mejor es que ahora entiendo POR QUÉ hago lo que hago.", rankBefore: "Plata II", rankAfter: "Oro III", sessionsCount: 5, createdAt: "2025-01-10" },
  { id: "r7", bookingId: "b7", coachId: "c3", studentId: "s7", studentName: "Andrés P.", studentAvatar: "🧑‍💻", rating: 5, comment: "El mejor coach de jungle que he tenido. Me enseñó a trackear al jungler enemigo como un pro.", rankBefore: "Oro I", rankAfter: "Platino II", sessionsCount: 3, createdAt: "2025-02-05" },
  { id: "r8", bookingId: "b8", coachId: "c6", studentId: "s8", studentName: "Roberto S.", studentAvatar: "👨‍💻", rating: 5, comment: "MidlaneProdigy es un crack. Me enseñó a roamear sin perder CS y a snowballear partidas.", rankBefore: "Platino IV", rankAfter: "Esmeralda II", sessionsCount: 8, createdAt: "2025-03-20" },
];
